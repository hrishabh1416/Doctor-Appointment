  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border-0 px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[20px] hover:bg-[#5F6FFF] hover:text-white transition-all duration-300 text-gray-600 cursor-pointer active:bg-[#5F6FFF] active:text-white'>
        <b>EFFICIENCY:</b>
